...
export function Textarea({ invalid, rows = 4, class: cls, value, ...rest }: TextareaProps) {
  ...
  return (
    <textarea
      rows={rows}
      class={`${INPUT_BASE} min-h-24 resize-y py-2.5 leading-relaxed ${stateClass}${cls ? ` ${cls}` : ''}`}
