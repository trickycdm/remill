...
import * as oauth_device_authorization from './routes/oauth/device-authorization';
...
export const loadRoutes = <T extends Env>(app: Hono<T>) => {
	...
	app.get('/oauth/device', ...oauth_device_index.onRequestGet);
	app.post('/oauth/device', ...oauth_device_index.onRequestPost);
	app.post('/oauth/device-authorization', ...oauth_device_authorization.onRequestPost);
	app.post('/oauth/register', ...oauth_register.onRequestPost);
