...
/** GET /api/collections/:slug — one collection definition. Discovery is public, but
...
export const onRequestGet = factory.createHandlers(async (c) => {
  ...
  const def = await getCollectionForDiscovery(getDb(c.env.DB), principal, pathParam(c, 'slug'));
