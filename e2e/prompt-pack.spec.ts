...
test.describe('Prompt library pack — install, author, and the privacy default', () => {
  test('full flow: install, author a prompt with variables, publish — and the public page 404s', async ({
    ...
    // THE PRIVACY PIN: prompts ship without publicRead — even a PUBLISHED
    // prompt has no anonymous public page. This is the pack's defining
    // difference from blog/changelog/portfolio/docs.
