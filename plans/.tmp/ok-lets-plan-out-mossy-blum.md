...
> **STATUS: NOT STARTED.** 11 phases, each independently shippable. This plan is written to be
...
|---|---|---|
| 1 | Query power: filter operators + FTS5 search | 1 |
| 1 | MCP parity: trash + delete/upload/revisions tools | 2, 3 |
| 1 | Audit surfacing + token last-used | 4 |
...
## Phase 1 — Query power: filter operators + FTS5 search
...
## Phase 2 — Cron infra + recoverable delete (trash)
...
## Phase 3 — MCP parity completion (upload + revisions)
...
## Phase 4 — Audit surfacing + token last-used
